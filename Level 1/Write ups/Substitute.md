...
The wizard talks a lot of garbage. Seeing as there's not significant clue on the type of cipher used to encrypt here, there's a fairly good chance that each character in the text has been substituted for another letter (also inferred by the name of the challenge). Using an online substitution tool (https://www.guballa.de/substitution-solver), we get:
